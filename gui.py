...
class GUI():
    ...
    def display_stats_frame(self):        
        ...
        # place widgets
        self.intro_message.grid(row=0, column=0, padx=5, pady=(5, 10), columnspan=2, sticky = 'N S')
        ...
        self.rev_label.grid(row=3, column=1, padx=5, pady=10, sticky = 'N S')
    ...
    def run_dfd(self, event=None):
        ...
        \n\nYou sold {self.dfdsim.lb} seat{lb_s} and earned ${self.dfdsim.rev:,}.', padx=5, pady=5)
